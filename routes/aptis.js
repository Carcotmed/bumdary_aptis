...
function aptisApi(app) {
    ...
    app.use(
        "/api/aptis/ejercicios_comprension_c",
        router_ejercicio_comprension_c
    );
    app.use(
        "/api/aptis/ejercicios_comprension_l",
        router_ejercicio_comprension_l
    );
    app.use("/api/aptis/ejercicios_listening", router_ejercicio_listening);
    app.use(
        "/api/aptis/ejercicios_writing_word",
        router_ejercicio_writing_word
    );
    app.use(
        "/api/aptis/ejercicios_writing_text",
        router_ejercicio_writing_text
    );
